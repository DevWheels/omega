...
public class ItemConfig : ScriptableObject {
    ...
    [Header("Basic Settings")] public string itemName;
    public ItemType itemType;
    public ItemRank Rank;
    public GameObject Prefab;

    [Header("Skills")] public List<SkillType> Skills;

    [Header("Stat Ranges By Rank")] public RankStatRanges dRankStats;
